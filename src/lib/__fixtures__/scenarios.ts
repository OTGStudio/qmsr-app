...
export function postmarketMDR(): Scenario {
  return {
    ...
    signals: ['MDR increase', 'Complaint trend', 'MDR — rising 3-year trend'],
    aiEnabled: false,
    swEnabled: true,
    cyberEnabled: false,
    pccpPlanned: false,
...
export function cyberForcause(): Scenario {
  return {
    ...
    signals: ['Cybersecurity signal', 'Software anomaly'],
    aiEnabled: false,
    swEnabled: true,
    cyberEnabled: true,
    pccpPlanned: false,
...
export function recallScenario(): Scenario {
  return {
    ...
    signals: ['Recall / correction', 'Class I recall', 'Open recall action'],
    aiEnabled: false,
    swEnabled: false,
    cyberEnabled: false,
    pccpPlanned: false,
...
export function aiDevice(): Scenario {
  return {
    ...
    signals: ['Clinical / performance drift'],
    aiEnabled: true,
    swEnabled: true,
    cyberEnabled: false,
    pccpPlanned: true,
...
export function deathMDR(): Scenario {
  return {
    ...
    signals: ['Death-type MDR reports', 'MDR increase'],
    aiEnabled: false,
    swEnabled: false,
    cyberEnabled: false,
    pccpPlanned: false,
...
export function supplierChange(): Scenario {
  return {
    ...
    signals: ['Supplier change', 'Incoming failures', 'Process variability'],
    aiEnabled: false,
    swEnabled: false,
    cyberEnabled: false,
    pccpPlanned: false,
...
export function contradictoryPremarket(): Scenario {
  return {
    ...
    feiNumber: '1234567890',
    inspType: 'pmaPre',
    marketedUS: true, // contradiction: premarket type but marketed
    pathway: 'standard',
    manualClass: '3',
    classSource: 'manual',
    deviceClass: '3',
